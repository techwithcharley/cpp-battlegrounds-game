...
int main() {
	...
	string userturn, difficulty, movedist;	// Strings to store the user's action and the current number of human players
...
// *********** Game setup *********** //
	...
	while (!(cin >> playermode)) {
		if (playermode != 1 || 2) {
			cout << "Please enter a valid option" << endl;
			cin.clear();
			cin.ignore(100, '\n'); // Store user input within playermode variable
		}
	}
		do {
